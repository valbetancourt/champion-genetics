...
horse1 = Horse.new(category: "showjumper", breed: "holsteiner" , height: "16.3", pedigree: "(BALOUBET DU ROUET x GEORGIA)", accomplishments: "Olympic gold medal", price: 2000, user: user1)
...
horse2 = Horse.new(category: "showjumper", breed: "holsteiner", height: "16.3", pedigree: "(CAPITOL I x KERRIN)", accomplishments: "bla bla", price: 3100, user: user1)
...
horse3 = Horse.new(category: "Race Horse", breed: "thoroughbred", height: "16.1", pedigree: "(HARLAN'S HOLIDAY x LESLIE'S LADY)", accomplishments: "bla bla", price: 250000, user: user1)
...
horse4 = Horse.new(category: "Race Horse", breed: "thoroughbred", height: "16.2", pedigree: "(BOLD RULER x SOMETHINGROYAL)", accomplishments: "bla bla", price: 125000, user: user2)
...
horse5 = Horse.new(category: "western", breed: "quarter horse", height: "15.3", pedigree: "(BLAZING HOT x VITAL SIGNS ARE GOOD)", accomplishments: "bla bla", price: 5000, user: user2)
...
horse6 = Horse.new(category: "western", breed: "quarter horse", height: "15.1", pedigree: "(A GOOD MACHINE x GYPSYS LITTLE IMAGE)", accomplishments: "bla bla", price: 5000, user: user2)
